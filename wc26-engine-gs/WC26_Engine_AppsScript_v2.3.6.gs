/**
 * WC26 Value Betting Engine — Apps Script (v2.3.6)
 *
 * v2.3.6 (this file — closes the FOUR end-to-end blockers v2.3.5 left open
...
function installEngine() {
  ...
  SpreadsheetApp.getActive().toast(
    'WC26 Engine v2.3.6 installed (knockouts pre-seeded). Auto-refresh every ' +
      POLL_MINUTES + ' min.',
    'Setup complete',
    8
  );
...
function _writeStatus_(msg) {
  Logger.log(msg);
  try {
    SpreadsheetApp.getActive().toast(msg, 'WC26 Engine v2.3.6', 4);
  } catch (_) {}
}
